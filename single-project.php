...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="ht__bradcaump__area" data--black__overlay="6" style="
          background: rgba(0, 0, 0, 0) url(assets/images/bg/5.jpg) no-repeat scroll
            center center / cover;
        ">
                ...
                <div class="ht-portfolio-pic-show">
                  <div class="ht-portfolio-full-image tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                      <img src="assets/images/blog/big-images/1.jpg" alt="full-image" />
                    </div>
                  </div>
                </div>
                <!-- Start Small images -->
                  ...
                  <ul role="tablist" class="prodict-det-small clearfix">
                    <li role="presentation" class="pot-small-img img-tab-1 active">
                      <a href="#img-tab-1" role="tab" data-toggle="tab">
                        <img src="assets/images/service/small-img/1.jpg" alt="small-image" />
                      </a>
                    </li>
                    <li role="presentation" class="pot-small-img img-tab-2">
                      <a href="#img-tab-2" role="tab" data-toggle="tab">
                        <img src="assets/images/service/small-img/2.jpg" alt="small-image" />
                      </a>
                    </li>
                    <li role="presentation" class="pot-small-img img-tab-3">
                      <a href="#img-tab-3" role="tab" data-toggle="tab">
                        <img src="assets/images/service/small-img/3.jpg" alt="small-image" />
                      </a>
                    </li>
                    <li role="presentation" class="pot-small-img img-tab-4">
                      <a href="#img-tab-4" role="tab" data-toggle="tab">
                        <img src="assets/images/service/small-img/4.jpg" alt="small-image" />
                      </a>
                    </li>
                  </ul>
                </div>
          ...
          <div class="col-md-12">
            <div class="htc__pro__desc__container">
              ...
              <div class="single__project__details">
                <h2>CONSTRUCTION</h2>
                <p>
                  On the other hand, we denounce with righteous tion and
                  dislike men who are so beguiled demorad On the ther hand, we
                  denounce with pain and trouble that re bound to ensue; and
                  equal blame belongs to those ho fail in their sty through
                  weakness of will, ch is the same as saying through shrinking
                  from
                </p>
              </div>
              <!-- End Single Details -->
              ...
              <div class="single__project__details">
                ...
                <p>
                  On the other hand, we denounce with righteous indignion and
                  dislike men who are so beguiled demoralized On the er hand,
                  we denounce with pain and trouble that are und to ensue; and
                  ual blame belongs to those who win
                </p>
                <p>
                  On the other hand, we denounce with righteous indignion and
                  dislike men who are so beguiled demoralized On the er hand,
                  we denounce with pain
                </p>
              </div>
              <!-- End Single Details -->
              <!-- start Single Details -->
              <div class="single__project__details">
                ...
                <p>
                  On the other hand, we denounce with righteous an dion and
                  dislike men who are so beguiled
                </p>
                <ul class="facts__list">
                  <li>
                    <a href="#"><i class="fa fa-angle-double-right"></i>On the other
                      hand, we denounce with rious indignion and dislike men
                      who we are</a>
                  </li>
                  <li>
                    <a href="#"><i class="fa fa-angle-double-right"></i>On the other
